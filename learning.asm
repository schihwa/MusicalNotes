...
main:
    ...
    while: 
        ...
        j outside_bounds             
            ...
            la $t3, colors # load the address of the colors array
            sll $t0, $t0, 2 # multiply the index by 4 to get the correct offset in the array
            add $t3, $t3, $t0 # add the offset to the array address to get the address of the desired color
            lw $a0, ($t3) # load the color value into $a0
